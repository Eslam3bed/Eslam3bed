...
export const Header = ({ onToggleTheme }: HeaderProps) => {
  const { status, tooltip } = useUserStatus();
      ...
      <div className="flex items-center space-x-4">
        <div className="relative">
          ...
          <div
            ...
            } rounded-full border-2 border-background dark:border-background-dark ${
      ...
      <div className="flex items-center space-x-2">
        <div className="flex items-center space-x-1">
          <Button variant="ghost" size="icon" asChild className="group">
            <a
              href="https://www.linkedin.com/in/eslam3bed/"
              target="_blank"
          ...
          <Button variant="ghost" size="icon" asChild className="group">
            <a
              href="https://github.com/Eslam3bed"
              target="_blank"
              rel="noopener noreferrer"
              title="GitHub"
            >
          ...
          <Button variant="ghost" size="icon" asChild className="group">
            <a
              href="https://stackoverflow.com/users/9976967/eslam-abu-hugair"
              target="_blank"
              rel="noopener noreferrer"
              title="Stack Overflow"
            >
              <svg
                className="h-4 w-4 group-hover:text-primary dark:group-hover:text-primary-dark transition-colors"
                viewBox="0 0 24 24"
                fill="currentColor"
              >
          ...
          <Button variant="ghost" size="icon" asChild className="group">
            <a
              href="mailto:e.eslam3bed@gmail.com?subject=I%20would%20like%20to%20hire%20you"
              title="Email"
            >
